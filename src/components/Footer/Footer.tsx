...
function Footer() {
  ...
  <div className=" bg-[#232F3E] mx-auto py-10">
    <ul className="flex justify-center flex-wrap text-sm text-white">
      <li className="mx-2"><Link href="#" className=" py-2 px-3"> <FaGithub className='w-8 h-8'/> </Link></li>
      <li className="mx-2"><Link href="#" className=" py-2 px-3"><FaYoutube className='w-8 h-8'/></Link></li>
